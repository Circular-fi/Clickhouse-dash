(() => {
  ...
  const dom = {
    ...
    tracesPrefillButton: byId("tracesPrefillButton"),
    tracesService: byId("tracesService"),
    tracesServiceOptions: byId("tracesServiceOptions"),
    tracesOperation: byId("tracesOperation"),
    tracesOperationOptions: byId("tracesOperationOptions"),
    tracesTagsButton: byId("tracesTagsButton"),
    ...
    tracesSourceMeta: byId("tracesSourceMeta"),
